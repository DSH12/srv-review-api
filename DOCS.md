...
```sh
[I] ➜ grpc_cli call localhost:8082 DescribeReviewV1 "id: 1"
connecting to localhost:8082
Rpc failed with status code 5, error message: review not found
```
...
```sh
$ pgcli "postgresql://docker:docker@localhost:5432/srv_review_api"
```
