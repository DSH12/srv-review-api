...
import (
	...
	"github.com/ozonmp/srv-review-api/internal/app/consumer"
	"github.com/ozonmp/srv-review-api/internal/app/producer"
...
func NewRetranslator(cfg Config) *retranslator {
	events := make(chan model.ReviewEvent, cfg.ChannelSize)
